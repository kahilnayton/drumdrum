...
AudioContext = require('/usr/local/lib/node_modules/web-audio-api').AudioContext

Gibber = require('/www/gibber.audio.lib/scripts/gibber/audio.lib.js')
...
a = Gibber.Audio.Synths.Mono('bass').note.seq( [0,7], 1/8 )
